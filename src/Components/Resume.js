               ...
               <div className='pt-14' style={{ backgroundImage: `url(${bgImg})` }}>
                    <section className='m-4 my-0 rounded-md p-3 sm:p-10' style={{ backgroundColor: "#111111" }} >
                         <div className="flex items-center ">
                              ...
                              <progress className="progress h-1 sm:w-48 w-20 ml-2 mt-2 sm:ml-5 progress-primary  bl ock" value="100" max="100"></progress>
                         </div>
                         <div className='flex items-center'>
                         ...
                         <div class="grid grid-cols-1 sm:grid-cols-2  gap-10">
                              <div>
                                   ...
                                   <div>
                                        ...
                                        <progress className="progress progress-info  w-full bg-gray-50 0" value="95" max="100"></progress>
                                        <div className='flex justify-between'>
                              ...
                              <div >
                                   ...
                                   <div class="flex gap-x-2 gap-y-2 md:gap-y-4 md:gap-x-4 flex-wrap">
                                        <button className="resume-btn btn glass text-xs sm:text-xl">HTML</button><button className="resume-btn btn glass text-xs sm:text-xl">CSS</button><button className="resume-btn btn glass text-xs sm:text-xl">Daisyui</button>
